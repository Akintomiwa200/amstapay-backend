...
const transactionSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: [
        "qr_payment", "normal_transfer",
        "airtime", "data", "cable", "electricity",
        "schoolfees", "transport", "merchant_payment", "payment_url",
        "fund", "withdraw",
        "international_transfer",
        "crypto_payment", "web3_deposit", "web3_withdrawal",
        "bill_payment",
        "group_contribution", "micro_loan", "fixed_deposit",
        "scheduled_payment", "money_request", "standing_order"
      ],
      required: true,
    },
